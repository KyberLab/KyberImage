...
# Image config phase
IMAGE_CONFIG_METHOD			?= buildroot
IMAGE_CONFIG_OPTS			?= 

# Image build phase
IMAGE_BUILD_METHOD			?= buildroot
IMAGE_BUILD_OPTS			?= 

# Image install phase
IMAGE_INSTALL_METHOD		?= file
IMAGE_INSTALL_OPTS			?= -fv
...
# Image clean phase
IMAGE_CLEAN_METHOD			?= buildroot
IMAGE_CLEAN_OPTS			?= 

# Image distclean phase
IMAGE_DISTCLEAN_METHOD		?= buildroot
